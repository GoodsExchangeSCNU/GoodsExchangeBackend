...
SECRET_KEY = 'django-insecure-8s&hy10ec*^l$p73y*l6%o@#h86vy=4w_p@rqr)0)k=&tk-pnv'
...
MEDIA_URL = '/'
MEDIA_ROOT = os.path.join(BASE_DIR.parent,'frontend/public/')
